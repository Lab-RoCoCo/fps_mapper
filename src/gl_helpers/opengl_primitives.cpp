...
namespace GLHelpers {
  ...
  // explicit type declaration, required when generating a shared library. add more types as needed.
  template void glMultMatrix(const Eigen::Isometry3f& iso);
  template void glMultMatrix(const Eigen::Affine3f& iso);
