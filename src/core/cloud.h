...
namespace fps_mapper {
  ...
  struct RichPoint {
    ...
    inline RichPoint(const Eigen::Vector3f& p = Eigen::Vector3f::Zero(), const Eigen::Vector3f& n=Eigen::Vector3f::Zero(), float a=0.0f, const Eigen::Vector3f& c=Eigen::Vector3f::Zero()){
      _point = p;
      _normal = n; 
      _rgb = c;
      _accumulator = a;
  ...
  struct Cloud: public boss::BLOB, public RichPointVector {
    ...
    void clip(float range, const Eigen::Isometry3f& pose=Eigen::Isometry3f::Identity());
  };
